...
class AddJobViewController: UIViewController {
    ...
    var jobDelegate: AddJobDelegate!
    ...
    func style() {
        ...
        logoImageView.image = UIImage(systemName: "questionmark.circle.fill", withConfiguration: UIImage.SymbolConfiguration(pointSize: 1))
    ...
    func layout() {
        ...
        NSLayoutConstraint.activate([
            ...
            companyNameField.leadingAnchor.constraint(equalTo: scrollView.safeAreaLayoutGuide.leadingAnchor, constant: 10),
            companyNameField.trailingAnchor.constraint(equalTo: scrollView.safeAreaLayoutGuide.trailingAnchor, constant: -10),
            ...
            positionField.trailingAnchor.constraint(equalTo: scrollView.safeAreaLayoutGuide.trailingAnchor, constant: -10),
            ...
            applicationStatusField.leadingAnchor.constraint(equalTo: scrollView.safeAreaLayoutGuide.leadingAnchor, constant: 10),
            applicationStatusField.trailingAnchor.constraint(equalTo: scrollView.safeAreaLayoutGuide.trailingAnchor, constant: -10),
            applicationStatusField.heightAnchor.constraint(equalToConstant: 40),
            
            applicationStatusFieldDownArrow.centerYAnchor.constraint(equalTo: applicationStatusField.centerYAnchor, constant: -5),
            applicationStatusFieldDownArrow.trailingAnchor.constraint(equalTo: applicationStatusField.trailingAnchor, constant: -15),
            ...
            addJobButton.trailingAnchor.constraint(equalTo: scrollView.safeAreaLayoutGuide.trailingAnchor, constant: -10),
            ...
            cancelButton.trailingAnchor.constraint(equalTo: scrollView.safeAreaLayoutGuide.trailingAnchor, constant: -10),
